        ...
        <div className="flex flex-wrap justify-around">
          <div className="max-w-xl my-3 w-full">
            <div className="w-full h-[420px] flex items-center justify-center overflow-hidden">
              ...
              /> */}
              <ImageWithLoader src={poster} alt={product.name} />
            </div>
          </div>
            ...
            <p className="my-3">
              {!inCart ? (
                <button
                  ...
                  className={`inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300
