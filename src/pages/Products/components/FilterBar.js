...
export const FilterBar = ({ setShowFilters }) => {
  const {
    sortBy,
    filterByRating,
    toggleBestSeller,
          ...
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  id="price-sort-1"
                  checked={sortByValue === "LOW_TO_HIGH"}
                  onChange={() => sortBy("LOW_TO_HIGH")}
                  type="radio"
                  value=""
                  name="price-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  id="price-sort-2"
                  checked={sortByValue === "HIGH_TO_LOW"}
                  onChange={() => sortBy("HIGH_TO_LOW")}
                  type="radio"
                  value=""
                  name="price-sort"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  onChange={(e) => toggleBestSeller(e.target.checked)}
                  type="checkbox"
                  value=""
