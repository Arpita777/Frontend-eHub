...
export const OrderFail = () => {
  return (
    <section className="text-xl text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
      ...
      <div className="my-5">
        ...
        <p>
          Connect <span className="">frontend_eHub@example.com</span> for
          support.
        </p>
      </div>
      <Link
 ...
 hover:bg-blue-800 rounded-lg text-lg px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-600 hover:bg-blue-700 focus:ring-blue-300
 focus:outline-none"
      >
